...
void UKF::UpdateLidar(const MeasurementPackage& meas_package) {
  ...
  */
  ...
  // Compute Lidar-NIS
  double lidar_nis = residual.transpose() * Sinv * residual;
  std::cout << "lidar_nis " << lidar_nis << "\n";
}
...
void UKF::UpdateRadar(const MeasurementPackage& meas_package) {
  ...
  */
  ...
  // Compute Radar-NIS
  double radar_nis = residual.transpose() * Sinv * residual;
  std::cout << "radar_nis " << radar_nis << "\n";
}
